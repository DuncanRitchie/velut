...
const anagramsArray = (input) => {
    ...
    let subwordsArray = []
    let remaining = []
    subwordsArray[0] = findSubwords(input,words)
    remaining[0] = input
    console.log("Number of findSubwords: "+subwordsArray[0].length)
    ...
    //         }
    //         else {
    //             subwordsArray[x+1] = findSubwords(remaining[x+1],subwordsArray[x])
    //             x++
    //         }
    //     }
    // }
