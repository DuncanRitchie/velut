...
import runOnThread from "./threaded"
...
export default async function findAnagramsThreaded(input) {
    try {
        ...
        return {
            success: true,
            error: null,
            anagrams: ['If you’re seeing this, I’m still working on the Anagram Phrases functionality! Please come back later!', 'Your search was “' + input + '”.'],
        }
    } catch (error) {
        return {
            success: false,
