...
- [ ] Add inflection-tables _locally_ on the front-end, using the output of the Inflector in the _local_ database. <ins>Currently in progress.</ins><br>
...
- [ ] Ensure I can push the inflection-table work to production and _not_ see the inflection-tables on the live website. The flat list of forms will continue to be shown if a lemma doesn’t have the `Forms` field.
