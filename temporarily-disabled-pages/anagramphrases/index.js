  ...
  return (
    <>
      ...
      <div className="fulmar-background">
        ...
        <p className={styles.subsiteHomeRubric}>This will help you find Latin phrases that are anagrams!</p>
        ...
        <Search type="anagramphrases" searchbarLabel="Text to find anagrams of" lang="zxx" hideDropdown={true} />
      </div>
    </>
  )
}
