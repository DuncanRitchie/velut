...
const findAnagramsAsObject = require('./findAnagrams')
...
const findOneWordFromQuery = function(req, res) {
...
const findOneWord = function(req, res, selection) {
...
const findOneWordSelectSeveralFields = function(req, res) {
	findOneWord(req, res, selectionForOneWord)
}

const findOneWordSelectOnlyWord = function(req, res) {
	findOneWord(req, res, {"Word": 1, "_id": 0})
}
...
const findAdvanced = function(req, res) {
...
module.exports = {
	count,
	findOneWordFromQuery,
	findOneWordSelectSeveralFields,
	findOneWordSelectOnlyWord,
	findWordsClassical,
	findWordsEcclesiastical,
	findWordsAlphabetical,
	findSubwords,
	findAnagrams,
	findAdvanced,
	findById,
