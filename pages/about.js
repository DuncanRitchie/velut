        ...
        <main>
          ...
          <section id="forms">
            ...
            <p>
              ...
              given as an alphabetically ordered sample, such as:{' '}
              <LatinLink targetWord="volā" /> <LatinLink targetWord="volāns" />{' '}
              <LatinLink targetWord="volās" /> <LatinLink targetWord="volat" />{' '}
              <LatinLink targetWord="volem" /> <LatinLink targetWord="volent" />{' '}
              <LatinLink targetWord="volēs" /> <LatinLink targetWord="volet" />{' '}
              <LatinLink targetWord="volō" />. There’s no labelling of forms as
              singular or plural or nominative etc, and many forms are missing
              (eg <LatinLink targetWord="volāre" />
              ).
            </p>
            <p>
            ...
            <p>
              I’ve checked all {getShowGeneratedFormsString()}. Those lemmata
              now have their forms displayed in reasonable inflection-tables on
              the velut website. Over time I will do the same for the remaining
              parts of speech.
            </p>
            <p>
