...
let WordFromJson = (props) => {
    ...
    return (
        <div className="word">
            ...
            <Search/>
            <p>You searched for the word <strong>{input}</strong>. {foundWord ? <span>The word <strong>{foundWord.Word}</strong> belongs to the following {wordLemmata.length} {wordLemmata.length===1 ? "lemma" : "lemmata"}:</span> : <span>Nothing was found.</span>}</p>
