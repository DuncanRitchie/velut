                ...
                <div>
                    ...
                    {missingWordsCount
                       ? (<>
                            ...
                            <p>
                                <a target="_blank" rel="noopener noreferrer" href={getHrefForDictionaryLinks(this.state.missingWords)} title="External webpage linking to other dictionaries (opens in new tab)">
