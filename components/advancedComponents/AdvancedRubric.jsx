...
const AdvancedRubric = () => {
  return (
    <details className={styles.advancedRubric}>
      ...
      <div className="collapsible-outer">
        <div className="collapsible-inner">
          <h2>How to use</h2>
          <p>
            This page allows you to search for Latin words by spelling,
            scansion, or both.
          </p>
          <p>
          ...
          <h3>Spelling</h3>
          <p>
            Here you can specify letters that must be in the word. Letters must
            be typed in lowercase (and without diacritics) for them to be
            treated as letters. Uppercase letters are reserved for “wildcards”,
            of which there are the following:
          </p>
          <ul>
            <li>
              A capital “C” means any consonant letter (bcdfghklmnpqrstvxyz).
            </li>
            <li>
              A capital “V” means any vowel letter (aeiouy). Even if “i” is
              pronounced as a consonant, it is treated as a vowel here; likewise
              for “u” when not spelt as “v” (as in{' '}
          ...
          <ul>
            ...
            <li>
              ...
              <Link href="../Augustus">Augustus</Link> and{' '}
              <Link href="../augustus">augustus</Link>. “VVgustus” returns the
            ...
            <li>
              ...
              <Link href="../augustus">augustus</Link>,{' '}
              <Link href="../Augusti-nus">Augustīnus</Link>, etc that are in
              velut.
            </li>
            <li>
              “h~V_” returns words that either begin with a vowel or begin with
              “h” plus a vowel.
            </li>
            <li>
              “_Vm~” returns words that either end with a vowel or end with a
              vowel plus “m”.
            </li>
            <li>
              “_” doesn’t return anything unless scansion is also set (see
              below).
            </li>
          </ul>
          <h3>Scansion</h3>
          <p>
            ...
            word. This is not case-sensitive, but anything other than the
            following will be ignored:
          </p>
          <ul>
            <li>
              “L” means a long syllable — one containing a long vowel or ending
          ...
          <p>
            In words where a vowel is followed by plosive consonant and then “l”
            or “r”, both consonants belong to the following syllable. This makes{' '}
            <Link href="../tetradrachmum">tetradrachmum</Link> begin with two
            short syllables.
          </p>
          <h4>Examples</h4>
          ...
          <ul>
            <li>
              ...
              <Link href="../Graecia">Graecia</Link> and{' '}
            ...
            <li>
              “LSSL.” returns words that can occupy the fifth and sixth feet of
              a dactylic hexameter, such as{' '}
            ...
            <li>
              “_” doesn’t return anything unless spelling is also set (see
              above).
            </li>
          </ul>
          <h3>Allow elision?</h3>
          <p>
            This controls how scansion works; if scansion is not set, the
            tickbox has no effect.
          </p>
          <p>
            ...
            <Link href="../amphithea-trum">amphitheātrum</Link> and{' '}
            <Link href="../quo-modocumque">quōmodocumque</Link> (as well as
            words like <Link href="../praevaleant">praevaleant</Link>, which has
            nothing to elide), and “LSSL.” does not.
          </p>
          <h3>Sorting</h3>
          <p>
            You can sort the results alphabetically, or you can sort by rhyme.
            If you sort by rhyme, words that rhyme the closest (under classical
            or ecclesiastical pronunciation systems) will appear closest
            together in the list of results.
          </p>
        </div>
      </div>
    </details>
